...
>
> ⚠️ **As of v0.8.0 (Phase 9J redeploy, 2026-08-18) this file describes the ORIGINAL deployment** (v0.8.2 / v0.8.3 do not change it). In the current container the app is started by the container **entrypoint** (supervisor only manages cloudflared/system services), the production DB is `/tmp/domain-monitor/data/domain-monitor.db`, and scheduled backup is implemented via **Phase 13C** (QwenPaw cron, NFS persistent backup dir). Current facts: `docs/PROJECT_HANDOVER.md`, `docs/DATABASE.md`, `docs/DISASTER_RECOVERY.md`.
